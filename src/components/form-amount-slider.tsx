...
export function FormAmountSlider<TFieldValues extends FieldValues>({
  ...
  // Read current form field (string or number) and normalize to a number for the slider
  ...
  const handleChange = React.useCallback(
    (newNumber: number) => {
      // Store as fixed-precision string in the form (RHF field is commonly a string)
